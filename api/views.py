...
from api.serializers import (ChatCreateSerializer, ChatSerializer,
                             LoginSerializer, MessagesSerializer,
...
class UserLogin(CreateAPIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if serializer.is_valid(raise_exception=True):
            ...
            return Response(
                {"message": "Login successful", "token": token, 'user': serializer.data}, status=status.HTTP_201_CREATED
            )
